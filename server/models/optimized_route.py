...
class OptimizedRoute(Base):
    ...
    driver_id: Mapped[int | None] = mapped_column(ForeignKey("Users.user_id"), nullable=True)
    ...
    run_id: Mapped[int] = mapped_column(ForeignKey("Optimization_runs.run_id"), nullable=False)
