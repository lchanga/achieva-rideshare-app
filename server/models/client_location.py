...
class ClientLocation(Base):
    ...
    __table_args__ = (
        CheckConstraint("location_type IN ('home','work','volunteer')", name="CHK_LocationType"),
        {"schema": "dbo"}, 
    )
    ...
    client_id: Mapped[int] = mapped_column(ForeignKey("dbo.Users.user_id"), nullable=False)
