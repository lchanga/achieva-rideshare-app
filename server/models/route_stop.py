...
class RouteStop(Base):
    ...
    route_id: Mapped[int] = mapped_column(ForeignKey("Optimized_routes.route_id"), nullable=False)
    request_id: Mapped[int] = mapped_column(ForeignKey("Ride_requests.request_id"), nullable=False)
